...
SECRET_KEY = 'django-insecure-zdl5qc%en&kltwlahbh4*fi&@s^4xhr5zl&rvh$9dy@5y7o%m6'
...
ASGI_APPLICATION = 'my_project.asgi.application'  # Correct ASGI application path
